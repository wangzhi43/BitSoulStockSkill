...
class StockCrawler:
    ...
    def fetch_sina(self, ts_code: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"source": "sina", "ts_code": ts_code, "status": "failed", "message": "Parse error or no data"}
        except Exception as e:
            return {"source": "sina", "ts_code": ts_code, "status": "failed", "message": str(e)}
